...
#define TITLE_SUB_TOP 7 // the top of the title view when a subtitle IS present
#define TITLE_HEIGHT 22 // title height, fixed
#define SUBTITLE_TOP 29 // the top of the subtitle, when present
...
- (UIView *)titleViewOrDefault {
    if (self.titleView)
        ...
        if (!titleLabel) {
            ...
            titleLabel.font = [UIFont fontWithName:@"Hill" size:17];
...
- (UIView *)subtitleViewOrDefault {
    if (self.subtitleView)
        ...
        if (!subtitleLabel) {
            ...
            subtitleLabel.font = [UIFont fontWithName:@"Hill" size:13];
            subtitleLabel.textColor = [UIColor colorWithWhite:0.6 alpha:1];
...
+ (SMCalloutBackgroundView *)systemBackgroundView {
    ...
    background.leftCapImage = [UIImage imageNamed:@"callout_left.png"];
    background.rightCapImage = [UIImage imageNamed:@"callout_right.png"];
    //    background.topAnchorImage = [self embeddedImageNamed:@"SMCalloutViewTopAnchor"];
    background.bottomAnchorImage = [UIImage imageNamed:@"callout_bottom_anchor.png"];
    background.backgroundImage = [UIImage imageNamed:@"callout_bg.png"];
